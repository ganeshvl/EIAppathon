...
import com.vl.eiappathon.MainActivity;
...
public class BlobGettingStartedTask extends AsyncTask<String, Void, Void> {
    ...
    public BlobGettingStartedTask(MainActivity act, TextView view, Uri mPhotoFileUri) {
        this.view = view;
        this.act = act;
        this.mPhotoFileUri = mPhotoFileUri;
    }
...
//            blob1.uploadText("Hello, World1");
            ...
            // Upload text to the blob
            blob2.uploadFromFile(mPhotoFileUri.getPath());
//            
//
//            // Get a reference to a blob in the container
...
//            blob3.uploadText("Hello, World3");
            ...
            for (ListBlobItem blobItem : container.listBlobs()) {
                ...
                if (blobItem instanceof CloudBlockBlob) {
                    // Download the text
                    final CloudBlockBlob retrievedBlob = (CloudBlockBlob) blobItem;
                    act.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {

                    try {
                    	//retrievedBlob.downloadToByteArray(buffer, bufferOffset);
                    	retrievedBlob.downloadToFile("/sdcard/tmp/img.jpg");
						//act.outputText(view, );
